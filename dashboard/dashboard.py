...
if st.session_state.page == "Данные":
    ...
    st.write('4) Итальянских ресторанов с большим кол-вом лайков больше чем грузинских')
    st.write('5) Гистограмма рейтингов грузинских ресторанов смещена вправо (высокие оценки), у итальянских — более равномерное распределение.'
             'Грузинские рестораны по сравнению с итальянскими выделяются своим стабильным высоким качеством')
    st.write('6) Вероятность того, что выбранное заведение грузинской кухни понравится больше,чем выбранное заведение итальянской кухни')
    st.write('7) В своем проекте я представила топ-10 ресторанов по разным критериям(рейтинг, кол-во лайков/дизлайков), '
             'поэтому в следующий раз я пойду в ресторан из предложенного мною списка')
    st.write('8) Говоря об анализе слов, я поняла, что акцент в отзывах на грузинские рестораны делается на '
